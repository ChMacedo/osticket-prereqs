...
<p>
Install os Ticket v1.15.8.  <br />
From the os ticket zip file extract and copy the "upload" folder to C:\inetpub\wwwroot. Then rename the folder "osTicket"
</p>
<br />
...
<p>
  Congratulations! osTicket is now fully installed.
</p>
